        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                    Welcome to the projects section! Here you can explore a collection of my open-source contributions and school projects built with modern web technologies.
                </p>
            </div>
